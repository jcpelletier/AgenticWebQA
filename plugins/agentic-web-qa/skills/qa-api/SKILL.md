---
description: "API and service QA: contract correctness, validation, auth, error handling, and API test traceability. Use when reviewing or testing API/service behavior."
---
...
- Feature-specific integration command(s) from the TDD testing plan
